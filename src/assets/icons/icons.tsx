...
export const AperitifIcon = () => (
    <Icon viewBox='0 0 24 24' w='24px' h='24px' fill='none'>
        <path fill='url(#a-aperitif)' d='M0 0h24v24H0z' />
        <defs>
            <pattern id='a-aperitif' width='1' height='1' patternContentUnits='objectBoundingBox'>
                <use xlinkHref='#b-aperitif' transform='matrix(.00781 0 0 .00781 .125 .125)' />
            </pattern>
            <image
...
export const FirstCourseIcon = () => (
    <Icon viewBox='0 0 24 24' w='24px' h='24px' fill='none'>
        <path fill='url(#a-first-course)' d='M0 0h24v24H0z' />
        <defs>
            <pattern
                id='a-first-course'
                width='1'
            ...
            >
                <use xlinkHref='#b-first-course' transform='matrix(.00694 0 0 .00694 .167 .167)' />
            </pattern>
            <image
...
export const SecondCourseIcon = () => (
    <Icon viewBox='0 0 24 24' w='24px' h='24px' fill='none'>
        <path fill='url(#a-second-course)' d='M0 0h24v24H0z' />
        <defs>
            <pattern
                id='a-second-course'
                width='1'
